...
#
# This file is configured to write the original files for the Asus Transformer
# Pad TF300T Mobile Docking keyboard back to their original location.
